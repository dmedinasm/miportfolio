...
const Projects = () => {
  return (
    <section className="py-12 px-[64px] my-2 flex flex-col">
        <h1 className="font-montserrat font-bold  text-[300%] mb-4 text-start">Proyectos Personales</h1>
        <p className="font-montserrat text-[130%] mb-12">Aquí te presento una selección de mis proyectos personales. Cada uno de ellos representa una oportunidad para explorar nuevas ideas, desarrollar mis habilidades y desafiarme a mí mismo.</p>
